...
WebUI.click(findTestObject('Flow PSD letter/Step 3 Option Selection psd/h3_I want to learn more about PSDs'))

WebUI.click(findTestObject('Object Repository/EEuu path/Page_Certapet Pre-screening/button_Next'))

WebUI.verifyElementPresent(findTestObject('Flow PSD letter/PLearn About Service dogs title/p_Learn About Psychiatric Service Dogs (PSDs)'), 
    0)

WebUI.verifyElementPresent(findTestObject('Flow PSD letter/PLearn About Service dogs title/Psychiatric Service Dog (PSD)'), 
    0)
